        ...
        link: function (scope, iElement, iAttrs, controller) {
            ...
            scope.$watch('sourceData', function () {
                if (Object.keys(scope.sourceData).length > 0) {
                    ...
                    var data = scope.sourceData["edmx:Edmx"]["edmx:DataServices"]["Schema"]["EntityType"];
                    var association = scope.sourceData["edmx:Edmx"]["edmx:DataServices"]["Schema"]["Association"];

                    start(association, data);
...
function start(association, data) {
    var nodeDataArray = [];
    var linkDataArray = [];
